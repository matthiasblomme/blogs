...
![cover](../../docs/posts/visdeurbel-automated-detection/cover2.png){ .md-banner }
...
In [part 1](/posts/visdeurbel-automated-detection/visdeurbel-fish-detector), I got the detector to the point where it could spot movement, filter out most of the obvious nonsense, and ping me on Telegram when something fishy (pun still intended) moved through the frame.
...
It is also just more fun this way.
...
IBM's Granite family has been on my radar since I wrote about [running Granite 4.0-1B on Android](/posts/running-granite-llm-on-android/run-granite-on-android/). When I looked at what to use for vision, Granite Vision 3.2-2b was an obvious candidate.
...
Nothing fancy, which was exactly the point. Not that I write evaluation harnesses from memory.
...
That was the workflow: edit a prompt, run the script, look at the misses, repeat.
...
[Part 3: Model training](/posts/visdeurbel-automated-detection/visdeurbel-model-training)
