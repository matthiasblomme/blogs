...
heavy work and exits, leaving the main container warmed and ready. It adds some complexity compared to the other options, 
but in return you get flexibility, faster startup, and potentially a lighter hit on your licenses.
...
I wasn’t aiming for a winner here. Just wanted to see what happens when you tweak startup at runtime. Turns out you have 
options, each with their own quirks. And with dynamic startup resources coming in the future, there’s still more ground 
to cover.
